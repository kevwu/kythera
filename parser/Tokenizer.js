class Tokenizer {
	constructor(inputStream) {
		...
		Tokenizer.keywords = " let new if else while each return break continue typeof as bool int float str fn obj type list import export include this true false null "
	}
